...
from aggregation_config import(ABM_FIPS_MAP, ABM_TABLE, BIG_CF_FILE, BLIZZARD_DIR, CF_2022_FILE,
                               CF_2023_FILE, CM_DIR, DAILY_FRACTIONS, DATA_DIR, H2H_DIR, HISTORICAL_SRP, 
...
# add 1 to the year to make a lagged feature and set to object to merge
CY_CF['year'] = CY_CF['year'] + 1
CY_CF['year'] = CY_CF['year'].astype(int).astype(str)
...
"""
if IMPUTE_H2H == True:
    df_save_path = 'y1_master_df_2023_jan15_laggedCY_fullCF.csv'
else:
